        ...
        client.get('dataHistory', (err, result) => {
            if(err) {
                ...
                if(result) {
                    ...
                    const invoice   = req.query.invoice ? req.query.invoice :'invoice'
                    ...
                    const filterData = _.filter(response, (item) => {
                        return item[invoice].toString().toLowerCase().includes(search)
                    })
                    ...
                    if (filterData.length > 0) {
                        ...
                        success(res, paginationData, pagination, 'Get all history from redis has been succeeded!')
                      } else {
